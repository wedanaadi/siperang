            ...
            <form class="form-horizontal" id="form">
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="KodeBarangMasuk" class="form-control" id="formKode" readonly="readonly" value="<?php echo $kodeBarangMasuk ?>">
                  </div>
                </div>
                <div class="form-group row">
...
<script>
  $(function() {
    ...
    $('#btnSave').on('click', function() {
      $.ajax({
        url: "<?php echo base_url() . 'c_barangmasuk/insertBarangMasuk' ?>",
        method: "POST",
        dataType: "JSON",
        data: {
