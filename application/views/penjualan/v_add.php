            ...
            <form class="form-horizontal" id="form">
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="KodeTransaksi" class="form-control" id="formKode" readonly="readonly" value="<?php echo $kodeTrx ?>">
                  </div>
                </div>
                <div class="form-group row">
        ...
        <div class="row mt-2">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="JumlahBayar" id="formJumlahBayar" class="form-control" placeholder="Masukan pembayaran" value="0" readonly>
        ...
        <div id="elCredit" style="display:none">
          <div class="row">
            <div class="form-group col-md-4 has-success" id="eldp">
              ...
              <input type="text" name="dp" id="" class="form-control formuang" value="0">
            </div>
            <div class="form-group col-md-4 has-success" id="elrem">
              <label for="" class="control-label">Sisa Pembayaran</label>
              <input type="text" name="remain" id="" class="form-control formuang" value="0" readonly>
            </div>
            <div class="form-group col-md-4 has-success">
              <label for="" class="control-label">Jatuh Tempo</label>
              <input type="text" name="due" id="" class="form-control tanggalset" value="<?php echo date('Y/m/d') ?>">
            </div>
          </div>
        </div>
      </div>
...
<script>
  $(function() {
    ...
    $('#btnSave').on('click', function() {
      $.ajax({
        url: "<?php echo base_url() . 'c_penjualan/insertTrx' ?>",
        method: "POST",
        dataType: "JSON",
        data: {
