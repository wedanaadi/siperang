      ...
      <form action="">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="NamaUser" id="formNamaUser" class="form-control" placeholder="Masukan nama user">
            <small id="NamaUser" class="error_msg invalid-feedback"></small>
          </div>
          <!-- end form Nama User -->
          <div class="form-group">
            <label for="formUsername">Username</label>
            <input type="text" name="Username" id="formUsername" class="form-control" placeholder="Masukan nama username">
            <small id="Username" class="error_msg invalid-feedback"></small>
          </div>

          <div class="form-group">
            <label for="formPassword">Password</label>
            <input type="password" name="Password" id="formPassword" class="form-control" placeholder="Masukan passoword">
            <small id="Password" class="error_msg invalid-feedback"></small>
          </div>

          <div class="form-group">
            <label for="formNomortelepon">Nomor telepon</label>
            <input type="text" name="telepon" id="formNomortelepon" class="form-control" placeholder="Masukan nama nomor telepon">
          ...
          <div class="form-group">
            ...
            <select name="bagian" id="formBagian" class="form-control select2" style="width: 100%;">
              <option value="" selected="selectd" disabled="disabled">-- PILIH BAGIAN AKSES --</option>
...
<script>
  $('form').on('submit', function(e) {
    e.preventDefault();
    $.ajax({
      url: "<?php echo base_url() . 'c_auth/buatUser' ?>",
      method: "POST",
      dataType: "JSON",
      data: {
