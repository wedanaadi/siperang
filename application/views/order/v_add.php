            ...
            <form id="form1" class="form-horizontal" id="form">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="NamaSupplier" class="form-control" id="formNamaSupplier" readonly="readonly" placeholder="Nama Supplier">
            ...
            <form id="form2" class="form-horizontal" id="form">
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="KodeOrder" class="form-control" id="formKode" readonly="readonly" value="<?php echo $KodeOrder ?>">
                  </div>
                </div>
                <div class="form-group row">
...
<script>
  $(function() {
    ...
    $('#btnSave').on('click', function() {
      $.ajax({
        url: "<?php echo base_url() . 'c_order/insertOrder' ?>",
        method: "POST",
        dataType: "JSON",
        data: {
